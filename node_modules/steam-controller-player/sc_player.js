...
class SteamControllerSequence {
	...
	setTempo(lineNum, tempo) {
		var update = (this.timerUpdates[lineNum] || {});
		update.beatsPerMinute = tempo;
		this.timerUpdates[lineNum] = update;
	}
	
	//setLinesPerBeat
	
	setSpeed(lineNum, speed) {
		var update = (this.timerUpdates[lineNum] || {});
		update.ticksPerLine = speed;
		this.timerUpdates[lineNum] = update;
	}
